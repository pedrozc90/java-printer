...
- `com.contare.printers.core.Printer` — high-level printer abstraction
- `com.contare.printers.core.BasePrinter` — shared implementation helpers
- `com.contare.printers.core.PrinterConnection` — lightweight TCP helper
...
```java
import com.contare.printers.core.PrinterConnection;
